...
var Modal = class {
  ...
  render() {
    ...
    const notInstalledProviders = this.defaultProviders.filter(
      (p) => this.installedProviders.findIndex((i) => i.id === p.id) === -1
...
export {
  Modal as connect_modal
};
//# sourceMappingURL=connect-modal.entry-CN34UWJU.js.map
