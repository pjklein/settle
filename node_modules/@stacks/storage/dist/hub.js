...
function makeLegacyAuthToken(challengeText, signerKeyHex) {
    ...
    if (parsedChallenge[0] === 'gaiahub' && parsedChallenge[3] === 'blockstack_storage_please_sign') {
        ...
        const token = (0, base64_js_1.fromByteArray)((0, common_1.utf8ToBytes)(JSON.stringify({ publickey, signature })));
        return token;
    }
...
async function connectToGaiaHub(gaiaHubUrl, challengeSignerHex, associationToken, fetchFn = (0, common_2.createFetchFn)()) {
    ...
    const address = (0, encryption_1.publicKeyToBtcAddress)((0, encryption_1.getPublicKeyFromPrivate)(challengeSignerHex));
    return {
        url_prefix: readURL,
...
async function getBucketUrl(gaiaHubUrl, appPrivateKey, fetchFn = (0, common_2.createFetchFn)()) {
    ...
    const address = (0, encryption_1.publicKeyToBtcAddress)((0, encryption_1.getPublicKeyFromPrivate)(appPrivateKey));
