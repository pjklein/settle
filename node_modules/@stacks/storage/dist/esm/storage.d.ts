...
export declare class Storage {
    ...
    handleSignedEncryptedContents(path: string, storedContents: string, app: string, privateKey?: string, username?: string, zoneFileLookupURL?: string): Promise<string | Uint8Array>;
    putFile(path: string, content: string | Uint8Array | ArrayBufferView | Blob, options?: PutFileOptions): Promise<string>;
