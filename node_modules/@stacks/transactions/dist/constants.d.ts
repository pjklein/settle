export declare const BLOCKSTACK_DEFAULT_GAIA_HUB_URL = "https://hub.blockstack.org";
...
export declare const STRING_MAX_LENGTH: number;
...
export declare function anchorModeFrom(mode: AnchorModeName | AnchorMode): AnchorMode;
...
export type MultiSigHashMode = AddressHashMode.P2SH | AddressHashMode.P2WSH | AddressHashMode.P2SHNonSequential | AddressHashMode.P2WSHNonSequential;
